	...
	document.getElementById("tuijian2").style.top=0.15*screenheight+"px";
	document.getElementById("tuijian2").style.height=0.05*screenheight+"px";
	document.getElementById("tuijian2").style.width=0.1*screenwidth+"px";
	document.getElementById("tuijian2").style.left=0.54*screenwidth+"px";
	document.getElementById("tuijian3").style.top=0.15*screenheight+"px";
	document.getElementById("tuijian3").style.height=0.05*screenheight+"px";
	document.getElementById("tuijian3").style.width=0.1*screenwidth+"px";
	document.getElementById("tuijian3").style.left=0.01*screenwidth+"px";
	document.getElementById("tuijian4").style.top=0.15*screenheight+"px";
	document.getElementById("tuijian4").style.height=0.05*screenheight+"px";
	document.getElementById("tuijian4").style.width=0.1*screenwidth+"px";
	document.getElementById("tuijian4").style.left=0.54*screenwidth+"px";
	for(var i=0;i<2;i++){
