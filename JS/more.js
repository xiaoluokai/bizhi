	...
	for(var i=0;i<16;i++){
		if(i<4){
			...
			document.getElementsByClassName("picture")[i].style.left=0.02*screenwidth+"px";
			document.getElementsByClassName("picture")[i].style.top=0.2*screenheight+0.01*i*screenheight+0.16*i*screenheight+"px";
		}
		if(i>=4){
			var num=i-4;
			document.getElementsByClassName("picture")[i].style.width=0.2*screenwidth+"px";
			document.getElementsByClassName("picture")[i].style.height=0.16*screenheight+"px";
			document.getElementsByClassName("picture")[i].style.left=0.23*screenwidth+"px";
			document.getElementsByClassName("picture")[i].style.top=0.2*screenheight+0.01*num*screenheight+0.16*num*screenheight+"px";
		}
		if(i>=8&&i<12){
			var num=i-8;
			document.getElementsByClassName("picture")[i].style.width=0.2*screenwidth+"px";
	...
	for(var i=0;i<16;i++){
		if(i<4){
			...
			document.getElementsByClassName("car")[i].style.top=0.2*screenheight+0.01*i*screenheight+0.16*i*screenheight+"px";
		}
		if(i>=4&&i<8){
			var num=i-4;
			document.getElementsByClassName("car")[i].style.width=0.2*screenwidth+"px";
			...
			document.getElementsByClassName("car")[i].style.top=0.2*screenheight+0.01*num*screenheight+0.16*num*screenheight+"px";
		}
		if(i>=8&&i<12){
			var num=i-8;
			document.getElementsByClassName("car")[i].style.width=0.2*screenwidth+"px";
	...
	for(var i=0;i<16;i++){
		if(i<4){
			document.getElementsByClassName("game")[i].style.width=0.2*screenwidth+"px";
			document.getElementsByClassName("game")[i].style.height=0.16*screenheight+"px";
			document.getElementsByClassName("game")[i].style.left=0.02*screenwidth+"px";
			document.getElementsByClassName("game")[i].style.top=0.2*screenheight+0.01*i*screenheight+0.16*i*screenheight+"px";
		}
		if(i>=4){
			var num=i-4;
			document.getElementsByClassName("game")[i].style.width=0.2*screenwidth+"px";
			document.getElementsByClassName("game")[i].style.height=0.16*screenheight+"px";
			document.getElementsByClassName("game")[i].style.left=0.23*screenwidth+"px";
			document.getElementsByClassName("game")[i].style.top=0.2*screenheight+0.01*num*screenheight+0.16*num*screenheight+"px";
		}
		if(i>=8&&i<12){
			var num=i-8;
			document.getElementsByClassName("game")[i].style.width=0.2*screenwidth+"px";
			document.getElementsByClassName("game")[i].style.height=0.16*screenheight+"px";
			document.getElementsByClassName("game")[i].style.left=0.55*screenwidth+"px";
			document.getElementsByClassName("game")[i].style.top=0.2*screenheight+0.01*num*screenheight+0.16*num*screenheight+"px";
		}
		if(i>=12){
			var num=i-12;
			document.getElementsByClassName("game")[i].style.width=0.2*screenwidth+"px";
			document.getElementsByClassName("game")[i].style.height=0.16*screenheight+"px";
			document.getElementsByClassName("game")[i].style.left=0.76*screenwidth+"px";
			document.getElementsByClassName("game")[i].style.top=0.2*screenheight+0.01*num*screenheight+0.16*num*screenheight+"px";
		}
	}
	for(var i=0;i<16;i++){
		if(i<4){
			document.getElementsByClassName("view")[i].style.width=0.2*screenwidth+"px";
			document.getElementsByClassName("view")[i].style.height=0.16*screenheight+"px";
			document.getElementsByClassName("view")[i].style.left=0.02*screenwidth+"px";
			document.getElementsByClassName("view")[i].style.top=0.2*screenheight+0.01*i*screenheight+0.16*i*screenheight+"px";
		}
		if(i>=4){
			var num=i-4;
			document.getElementsByClassName("view")[i].style.width=0.2*screenwidth+"px";
			document.getElementsByClassName("view")[i].style.height=0.16*screenheight+"px";
			document.getElementsByClassName("view")[i].style.left=0.23*screenwidth+"px";
			document.getElementsByClassName("view")[i].style.top=0.2*screenheight+0.01*num*screenheight+0.16*num*screenheight+"px";
		}
		if(i>=8&&i<12){
			var num=i-8;
			document.getElementsByClassName("view")[i].style.width=0.2*screenwidth+"px";
			document.getElementsByClassName("view")[i].style.height=0.16*screenheight+"px";
			document.getElementsByClassName("view")[i].style.left=0.55*screenwidth+"px";
			document.getElementsByClassName("view")[i].style.top=0.2*screenheight+0.01*num*screenheight+0.16*num*screenheight+"px";
		}
		if(i>=12){
			var num=i-12;
			document.getElementsByClassName("view")[i].style.width=0.2*screenwidth+"px";
			document.getElementsByClassName("view")[i].style.height=0.16*screenheight+"px";
			document.getElementsByClassName("view")[i].style.left=0.76*screenwidth+"px";
			document.getElementsByClassName("view")[i].style.top=0.2*screenheight+0.01*num*screenheight+0.16*num*screenheight+"px";
		}
	}
	function display(id){
